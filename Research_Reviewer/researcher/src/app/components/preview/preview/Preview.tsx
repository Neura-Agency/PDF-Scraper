...
const Preview = ({ responseData, loading }: PreviewProps) => {
  ...
  return (
    <div className="min-h-screen max-md:w-full p-12 h-full w-[60%]">
      <div className="bg-[#000B16]/70 border-1 border-[#27d2f070] rounded-4xl bg-opacity-48 h-full max-md:w-full p-4 overflow-hidden">
